                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form class="form-horizontal" method="post" action="{{ route('admin.account.update') }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('admin.account.edit') }}" class="btn btn-default">Cancel</a>
